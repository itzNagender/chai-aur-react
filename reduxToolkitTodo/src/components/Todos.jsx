...
function Todos() {
  ...
  return (
    <>
      <div>Todos</div>
      <ul className="list-none w-full flex flex-col items-center justify-center">
        {todos.map((todo) => (
          <li
            className="mt-4 flex items-center justify-between bg-zinc-800 px-4 py-2 rounded w-1/3"
            key={todo.id}
          >
